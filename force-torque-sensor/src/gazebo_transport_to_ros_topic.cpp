...
int main(int argc, char **argv)
{
  ...
  // Get ROS params
  std::string gazebo_transport_topic_to_sub= "/gazebo/default/robot/wrist_3_link/wrench";
  std::string ros_topic_to_pub="wrench";
  
  //double ros_rate;
  //ros::param::get("~gazebo_transport_topic_to_sub", gazebo_transport_topic_to_sub);
  //ros::param::get("~ros_rate", ros_rate);

  pub = n.advertise<geometry_msgs::WrenchStamped>(ros_topic_to_pub, 1);
