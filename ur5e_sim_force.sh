...
sleep 1;roslaunch ur_e_gazebo ur5e.launch transmission_hw_interface:=hardware_interface/PositionJointInterface&# transmission_hw_interfac:=hardware_interface/VelocityJointInterface&
...
sleep 4;roslaunch gravity_compensation gravity_compensation_sim.launch;
